...
import com.finco.bank.view.AddCompanyBankView;
import com.finco.bank.view.AddPersonBankView;
...
public class CcardView extends FinCoView {
    ...
    public CcardView(AccountService accountService, CustomerService customerService) {
